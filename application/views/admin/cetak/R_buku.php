  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                    <a href="'.base_url().'admin/Cetak/barcode_buku/?id_buku='.$op['id_buku'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="Cetak Barcode Buku"><i class="fa fa-print"></i></a>
                    </div>
                </td>
            </tr>';?>
<?php
