            ...
            <div id="header1_div">
                ...
                <h2>Jalan Purbaya 24, Tridadi, Sleman</h2></div>
                    <div class="bio_div"><div id="garis"><hr></div>
                        ...
                        <div class="barcode_div"><img width="175px" height="40px" style="width: 100%; border=" 0px"="" src="<?php echo site_url();?>petugas/cetak/barcode_anggota/?id_anggota=<?php echo $value['id_anggota'];?>""></div></div>
        </td>
